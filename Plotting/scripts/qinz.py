...
plt.figure(figsize = (1.61*7,7))

plt.subplot(4, 2, 1)
plt.plot(z, b)
xlim,ylim = plt.xlim(), plt.ylim()
plt.plot([xlim[0], 1, 1], [b[index_1A],  b[index_1A], ylim[0]] , linestyle = '--', linewidth = 1.2, color = 'lightcoral')
...
plt.plot(z, f)
xlim,ylim = plt.xlim(), plt.ylim()
plt.plot([xlim[0], 1, 1], [f[index_1A],  f[index_1A], ylim[0]] , linestyle = '--', linewidth = 1.2, color = 'lightcoral')
...
plt.plot(z, h)
xlim,ylim = plt.xlim(), plt.ylim()
plt.plot([xlim[0], 1, 1], [h[index_1A],  h[index_1A], ylim[0]] , linestyle = '--', linewidth = 1.2, color = 'lightcoral')
...
plt.plot(z, q)
xlim,ylim = plt.xlim(), plt.ylim()
plt.plot([xlim[0], 1, 1], [q[index_1A],  q[index_1A], ylim[0]] , linestyle = '--', linewidth = 1.2, color = 'lightcoral')

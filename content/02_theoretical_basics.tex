...
\begin{equation*}
    H = t\sum_{i,j} \left ( c_i^\dagger c_j + c_j^\dagger c_i \right ) 
\end{equation*}
beschrieben. 
...
In diesem Modell wird sich auf das nächste Nachbarn hüpfen beschränkt, so dass höheres Hüpfen vernachlässigt wird. 
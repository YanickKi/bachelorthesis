...
\section{Bestimmung der Slater-Koster-Integrale}
...
\end{equation}
umdefiniert.
\section{Bestimmung der Hybridisierungsfunktion}
...
\begin{equation*}
    ...
    {z^2-\varepsilon_{\vec{k}}^2} \; .
\end{equation*}
\section{Bestimmung der Hybridisierungsfunktion mittels Basistransformation}
...
\begin{figure}
    ...
    \caption{Vorfaktoren der SK-Integrale (Vorfaktoren in Gl. \eqref{eqn:Vorfaktoren}, SK-Integrale in \ref{tab:slaterkosters}) in Abhängigkeit der der Höhe des Mn.
    Die Höhe varriert von $\qty{0}{\nano\metre}$ (Mn in Graphenebene) bis $\qty{1}{\nano\metre}$.}
    \label{fig:Faktoreninz}
\end{figure}
Zwar wird der Fall $z=\qty{0}{\nano\metre}$ in den Graphen abgedeckt, jedoch muss beachtet werden, dass das Mn in dem Experiment \cite{doi:10.1021/acsnano.1c00139} immer außerhalb der Graphenebene lag, so dass
dieser Fall eine rein theoretische Betrachtung ist.
In Abbildung \ref{fig:Faktoreninz}a
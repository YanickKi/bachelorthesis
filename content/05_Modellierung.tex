...
\begin{align}
    H = -t\sum_{ij}(c^\dagger_i c_j + c^\dagger_j c_i) + \varepsilon \sum_{m=0} \tilde{d}^\dagger_m \tilde{d}_m +
    \sum_{mj}(\gamma_{mj} \tilde{d}^\dagger_m \tilde{c}_j + \gamma_{mj} \tilde{c}^\dagger_j \tilde{d}_m) \; .
\end{align}
...
\begin{align*}
    \tilde{c}_0 &= \frac{1}{\sqrt{3N}}\sum_{j\vec{k}}\symup{e}^{i{\vec{k}}(\vec{l}+\vec{\delta}_j)}                                                      \\
...
\end{align*}
mit $\alpha_j \coloneq \symup{i}\frac{2(j-1)\pi}{3}$ und dessen Eigenschaft folgt $\overline{\alpha}_j = - \alpha_j$
\begin{align*}
    H = &-t \sum_{j \vec{k}} ( \symup{e}^{i\vec{k}\vec{\delta}_j}c^\dagger_{A,\vec{k}} c_{B,\vec{k}} + 
    \symup{e}^{-i\vec{k}\vec{\delta}_j} c^\dagger_{B,\vec{k}}c_{A,\vec{k}}) + 
    \varepsilon \sum_m \tilde{d}^\dagger_m \tilde{d}_m \\
    &+\frac{1}{\sqrt{3N}} \sum_{m=0}^4 \sum_{j=0}^2 \sum_{\vec{k}} 
    (\gamma_{mj} \symup{e}^{i{\vec{k}}(\vec{l}+\vec{\delta}_j)+(-1)^m \alpha_j(1-\delta_{m4})} c_{\text{B}, \vec{k}} \tilde{d}^\dagger_m c_{B,\vec{k}} \\
    &+ \gamma_{mj}  \symup{e}^{-i{\vec{k}}(\vec{l}+\vec{\delta}_j)-(-1)^m \alpha_j(1-\delta_{m4})} c^\dagger_{B,\vec{k}} \tilde{d}_m)
\end{align*}
Hybridisierungsfunktion gegeben durch 
\begin{align*}
    \frac{z}{3N} \sum_{\vec{k}} \frac{\sum_j \gamma_{mj} \symup{e}^{i{\vec{k}}(\vec{l}+\vec{\delta}_j)+(-1)^m \alpha_j(1-\delta_{m4})} }
    {z^2 - t^2 \sum_j \symup{e}^{\symup{i}\vec{k}\vec{\delta}_j} \sum_j \symup{e}^{-\symup{i}\vec{k}\vec{\delta}_j}}
\end{align*}
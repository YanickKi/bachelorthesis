...
\begin{align*}
    z&G_{d_m, d_{m'}^\dagger}(z) = \delta_{mm'} + \varepsilon_m G_{d_m, d^\dagger_{m'}}(z) + \frac{1}{\sqrt{N}}\sum_{j\vec{k}} V_{mj} 
    \symup{e}^{\symup{i}\vec{k} (\vec{l} + \vec{\delta}_j)} G_{c_{\text{B},\vec{k}}, d^\dagger_{m'}} \\
    \iff &G_{d_m, d_{m'}^\dagger}(z) = \frac{\delta_{mm'} +  \frac{1}{\sqrt{N}}\sum_{j\vec{k}} V_{mj} 

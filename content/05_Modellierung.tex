...
\end{align*}
Der Vorfaktor $\frac{1}{2}$ dient erneut zur Normierung und gewährt ebenfalls die Antikommutatorrelation $\{ \tilde{d}_i, \tilde{d}^\dagger_j \} = \delta_{ij}$ .
Mit den neuen Linearkombinationen für Vernichter $d_i$ vereinfacht sich $H_\text{Kop}$ zu 
%\begin{equation*}
%    
%\end{equation*}
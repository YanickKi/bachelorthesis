...
Der Tight Binding Hamiltonian in einer nächsten-Nachbarn Näherung für Graphen lautet
\begin{equation*}
...
\end{equation*}
Dazu werden Fouriertransformationen für die $p_z$-Orbitale
\begin{equation*}
...
\end{equation*}
gebracht werden.
Die Eigenwerte der auftretenden $2 \times 2$-Matrix bilden die Dispersionsrelation, welche
gemäß
\begin{equation*}
    \begin{vmatrix}
